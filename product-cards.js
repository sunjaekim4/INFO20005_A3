class AppleOatCookies extends HTMLElement {
    connectedCallback() {
        this.innerHTML = `
            <div class="product-card">
                <a class="cover-img-link" href="../products/apple-and-oat-cookies.html">    
...
customElements.define('apple-oat-cookies', AppleOatCookies);


class AppleCrunch extends HTMLElement {
    connectedCallback() {
        this.innerHTML = `
            <div class="product-card">
                <a class="cover-img-link" href="../products/apple-crunch.html">
...
customElements.define('apple-crunch', AppleCrunch);


class BdayBone extends HTMLElement {
    connectedCallback() {
        this.innerHTML = `
            <div class="product-card">
                <a class="cover-img-link" href="../products/bday-bone.html">
...
customElements.define('bday-bone', BdayBone);


class BeefBites extends HTMLElement {
    connectedCallback() {
        this.innerHTML = `
            <div class="product-card">
                <a class="cover-img-link" href="../products/beef-bites.html">
...
customElements.define('beef-bites', BeefBites);


class BeefLiver extends HTMLElement {
    connectedCallback() {
        this.innerHTML = `
            <div class="product-card">
                <a class="cover-img-link" href="../products/beef-liver.html">
...
customElements.define('beef-liver', BeefLiver);


class BeefTendons extends HTMLElement {
    connectedCallback() {
        this.innerHTML = `
            <div class="product-card">
                <a class="cover-img-link" href="../products/beef-tendons.html">
...
customElements.define('beef-tendons', BeefTendons);


class CarrotCrunch extends HTMLElement {
    connectedCallback() {
        this.innerHTML = `
            <div class="product-card">
                <a class="cover-img-link" href="../products/carrot-crunch.html">
...
customElements.define('carrot-crunch', CarrotCrunch);
...
class ChickenFeet extends HTMLElement {
    connectedCallback() {
        this.innerHTML = `
            <div class="product-card">
                <a class="cover-img-link" href="../products/chicken-feet.html">
...
class ChookBugs extends HTMLElement {
    connectedCallback() {
        this.innerHTML = `
            <div class="product-card">
                <a class="cover-img-link" href="../products/chook-bugs.html">
...
customElements.define('chook-bugs', ChookBugs);
...
class LambCrumble extends HTMLElement {
    connectedCallback() {
        this.innerHTML = `
            <div class="product-card">
                <a class="cover-img-link" href="../products/lamb-crumble.html">
...
class SardinesFish extends HTMLElement {
    connectedCallback() {
        this.innerHTML = `
            <div class="product-card">
                <a class="cover-img-link" href="../products/sardines-fish.html">
...
class PeanutButterCookies extends HTMLElement {
    connectedCallback() {
        this.innerHTML = `
            <div class="product-card">
                <a class="cover-img-link" href="../products/peanut-butter-cookies.html">
...
class VeggieCrunch extends HTMLElement {
    connectedCallback() {
        this.innerHTML = `
            <div class="product-card">
                <a class="cover-img-link" href="../products/veggie-crunch.html">
...
customElements.define('veggie-crunch', VeggieCrunch);
